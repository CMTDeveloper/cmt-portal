...
import { OverrideEnrollmentBodySchema } from '@cmt/shared-domain';
...
export async function PATCH(
  ...
  // eid = "{fid}-{pid}" — extract fid as everything before the last "-{pid}" segment.
  // We look up the enrollment by collectionGroup query to avoid needing the fid upfront.
